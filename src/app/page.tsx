  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[80vh] gap-12 relative px-4 text-center mt-8">
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="max-w-4xl flex flex-col items-center gap-6 z-10 mx-auto w-full"
      >
        ...
        <motion.p variants={itemVars} className="text-3xl sm:text-4xl text-[var(--color-ink)] max-w-2xl leading-relaxed font-bold mt-4">
          The ultimate food management app.
        </motion.p>
        
        <motion.div variants={itemVars} className="flex flex-wrap items-center justify-center gap-6 mt-6">
          <a 
            href={appLink}
            target="_blank"
            rel="noopener noreferrer"
            className="sketch-btn flex items-center gap-2 text-xl"
          >
